...
| Card Name | Initiative | SP Cost | Range | Effect | Heat | Taint | Copies |
|-----------|-----------|---------|-------|--------|------|-------|--------|
| ❄ Frost Bolt | [2] | 2 | Medium (4-6) | Deal 3 ice damage. Slow target (move -1 hex). | -1 | 0 | 2 |
| ❄ Ice Wall | [4] | 3 | Close (2-3) | Create blocking terrain for 2 turns. | -2 | 0 | 1 |
| ❄ Glacial Spike | [3] | 3 | Medium (4-6) | Deal 5 ice damage. Root target (cannot move). | 0 | 0 | 1 |
| ❄ Absolute Zero | [7] | 5 | Self (AOE 2) | Deal 6 ice damage to all in range. Remove all your Heat. | -all | Req 3+ | 1 |
